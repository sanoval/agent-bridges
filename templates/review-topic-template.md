...
signal on whether Fast or Deep pin is under-powered without muddling the metrics.)
...
step mana yang jalan untuk unit ini) | Coder re-sends unit ini: <N> (Fast/Deep)
